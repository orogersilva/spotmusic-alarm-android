...
import com.orogersilva.spotmusicalarm.featuredashboard.di.module.ClockAlarmManagerModule
...
@ActivityScope
@Component(modules = [ClockAlarmManagerModule::class, SpotifyModule::class],
